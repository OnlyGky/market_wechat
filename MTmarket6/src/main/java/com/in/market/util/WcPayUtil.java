...
public class WcPayUtil {
    ...
    public static String getPrice(String json){
        JSONObject jsonObject= JSONObject.parseObject(json);
       Double re= Double.valueOf(jsonObject.getString("price"))*100;

        return String.format("%.0f", re);
    }


    public static String getOrder(String json) {
        JSONObject jsonObject= JSONObject.parseObject(json);
    ...
    public static int getCode(String json) {
        ...
        System.out.println(json);
          String c=jsonObject.getString("hashcode");
        System.out.println("获取校验码"+c);
